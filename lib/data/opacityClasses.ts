...
export default {
	...
	// Border Opacity
	"border-opacity-0": { _uiElement: "stroke", transparency: 1 },
	"border-opacity-5": { _uiElement: "stroke", transparency: 0.95 },
	"border-opacity-10": { _uiElement: "stroke", transparency: 0.9 },
	"border-opacity-20": { _uiElement: "stroke", transparency: 0.8 },
	"border-opacity-25": { _uiElement: "stroke", transparency: 0.75 },
	"border-opacity-30": { _uiElement: "stroke", transparency: 0.7 },
	"border-opacity-40": { _uiElement: "stroke", transparency: 0.6 },
	"border-opacity-50": { _uiElement: "stroke", transparency: 0.5 },
	"border-opacity-60": { _uiElement: "stroke", transparency: 0.4 },
	"border-opacity-70": { _uiElement: "stroke", transparency: 0.3 },
	"border-opacity-75": { _uiElement: "stroke", transparency: 0.25 },
	"border-opacity-80": { _uiElement: "stroke", transparency: 0.2 },
	"border-opacity-90": { _uiElement: "stroke", transparency: 0.1 },
	"border-opacity-95": { _uiElement: "stroke", transparency: 0.05 },
	"border-opacity-100": { _uiElement: "stroke", transparency: 0 },
